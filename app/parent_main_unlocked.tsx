      ...
      >
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.header}>
            <TouchableOpacity
              onPress={() => router.replace('/parent_main_locked')}
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>
              내 아이 <Text style={{ color: '#70BF5A' }}>식습관</Text> 요약
            </Text>
            <View style={styles.summaryBox}>
              <Text style={styles.summaryText}>
                김민서님은 현재 (또래 기준) 당류 섭취량 조절이 필요합니다.
              </Text>
            </View>
          </View>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.replace('/parent_main_detailed')}
            accessibilityRole="button"
          >
