  ...
  return (
    <LoginBackground>
      ...
      <SafeAreaView style={styles.container}>
        ...
        {/* 텍스트 박스 */}
        <Text style={styles.bigText}>아이쿠, 미안!</Text>
        ...
        <View style={styles.gridContainer}>
          <TouchableOpacity
            ...
            style={[
              styles.selectBox,
              selected === 'sel1' && styles.selectBoxSelected,
            ]}
          >
          ...
          <TouchableOpacity
            onPress={() => handleSelect('sel3')}
            disabled={isDisabled}
            style={[
              styles.selectBox,
              selected === 'sel3' && styles.selectBoxSelected,
            ]}
          >
          ...
          <TouchableOpacity
            onPress={() => handleSelect('sel4')}
            disabled={isDisabled}
            style={[
              styles.selectBox,
              selected === 'sel4' && styles.selectBoxSelected,
            ]}
          >
          ...
          <TouchableOpacity
            onPress={() => handleSelect('sel5')}
            disabled={isDisabled}
            style={[
              styles.selectBox,
              selected === 'sel5' && styles.selectBoxSelected,
            ]}
          >
          ...
          <TouchableOpacity
            onPress={() => handleSelect('sel6')}
            disabled={isDisabled}
            style={[
              styles.selectBox,
              selected === 'sel6' && styles.selectBoxSelected,
            ]}
          >
          ...
          <TouchableOpacity
            onPress={() => handleSelect('sel7')}
            disabled={isDisabled}
            style={[
              styles.selectBox,
              selected === 'sel7' && styles.selectBoxSelected,
            ]}
          >
          ...
          <TouchableOpacity
            onPress={() => handleSelect('sel8')}
            disabled={isDisabled}
            style={[
              styles.selectBox,
              selected === 'sel8' && styles.selectBoxSelected,
            ]}
          >
          ...
          <TouchableOpacity
            onPress={() => handleSelect('sel9')}
            disabled={isDisabled}
            style={[
              styles.selectBox,
              selected === 'sel9' && styles.selectBoxSelected,
            ]}
          >
